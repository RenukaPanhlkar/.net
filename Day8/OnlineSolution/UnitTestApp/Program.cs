...
namespace UnitTestApp
{
	...
	internal class Program
    {
		static void Main(string[] args)
		{
			...
			Employee newEmp= new Employee { ID = 63, FirstName = "Rishabgh", LastName = "Sonpure", Department = "IT", Location = "Pune", ContactNumber = "9881734667", Email = "rishabh.sonpure@gmail.com" };
