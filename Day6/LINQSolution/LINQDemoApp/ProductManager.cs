...
namespace LINQDemoApp
{
    ...
    //  Business Intelligence Logic ( BI)
    //  Business Analytics
    ...
    public  class ProductManager
    {
        ...
        public List<Product> GetSoldOutProducts()
        {
            ...
            //var soldOutProducts = products.Where(current => current.UnitPrice <= 20);
           
            var soldOutProducts=from product in products where product.Balance==0 select product;
            return soldOutProducts.ToList();
        ...
        public   List<string> GetFruitsOrderby()
        {
        ...
        public   List<Product> GetProductsByDescending()
        {
            List<Product> products = GetAllProducts();
        ...
        public   List<Product> GetProductsGroupByCategory()
        {
            List<Product> products = GetAllProducts();
